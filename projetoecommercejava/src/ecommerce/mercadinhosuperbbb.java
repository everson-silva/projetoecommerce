...
public class mercadinhosuperbbb {
	...
	public static void main(String[] args) {
		...
		*/
		...
		//===========================================================Aqui é a parte de controle de estoque
		do
		{
		...
		//===========================================================Aqui é a parte do carrinho de compras
		do 
		{
		...
		contador=0;
			...
			for (int x=0;x<10;x++)
			{
				if (produto.equals(codigo[x])) 
				{
					...
					{
						System.out.println(codigo[x] +"\t" + produtos[x] +"\t\t R$ " + valor[x] +"\t\t por " + unidadeProdutos[x] + "\t\t em estoque: " + estoque[x]);
						System.out.println("Quanto(s) "+ unidadeProdutos[x]+ "(s) você quer comprar? Obs: O minimo de compra é 10 por "+ unidadeProdutos[x]+"(s).");
		...
		for (int x=0;x<10;x++)
		{
			if (precoCompra[x]>0)
			{
				System.out.println(codigo[x] +"\t" + produtos[x] +"\t\t Quantidade: "+carrinhoQuantidade[x]+"\t\t Valor total : R$" +valorAgregado[x]); 
			}
		}
